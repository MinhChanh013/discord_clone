...
import English from './LanguageImg/English.png'
import Čeština from './LanguageImg/Čeština.png'
import Dansk from './LanguageImg/Dansk.png'
import Brasil from './LanguageImg/Brasil.png'
import VietNam from './LanguageImg/VietNam.png'
import български from './LanguageImg/български.png'
import 繁體中文 from './LanguageImg/繁體中文.png'
import Norwegian from './LanguageImg/Norwegian.png'
import './Footer.scss'
const Footer = () => {
  ...
  const handelActive = (i, activity) => {
    if (i === dataLanguage[i].id) {
      activity = 'active'
      setIdLanguage(i)
    }
  }
            ...
            render={(attrs) => (
              <div className='menu-list' tabIndex="-1" {...attrs}>
                {dataLanguage.map((item, i) => {
                  let activity = ''
                  return (
                    <Button key={i} className={activity} onClick={() => { handelActive(i, activity) }}><img src={item.img} className='src-language' />{item.language} , {item.code} </Button>
                  )
                })}
              </div>
            )}
          >
            <button className='main-language'>
              <img src={dataLanguage[idLanguage].img} className='src-language' />
              {dataLanguage[idLanguage].language},
              {dataLanguage[idLanguage].code}
            </button>
          </Tippy>
